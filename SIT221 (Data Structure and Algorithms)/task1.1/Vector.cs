...
namespace task1._1
{
    public class Vector<T>
    {
        ...
        {
            // Function: to insert a new element into the specifed index
        ...
        {
            // Function: to see if the vector contains the specified element
        ...
        {
            // Fucntion: to convert the vector into a string
            string result = "";
            result += "[";
            for (int i = 0; i < Count; i++)
            {
                result += Convert.ToString(data[i]);
                if (i != Count-1) {
                    result += ", ";
                }
            }
